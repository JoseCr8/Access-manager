...
from secure_all import AccessManager, KeysJsonStore, RequestJsonStore, RevokedKeysStorage
...
class MyTestCase(unittest.TestCase):
    ...
    def test_singleton_access_manager( self ):
        ...
        revoked_keys_store_1 = RevokedKeysStorage()
        revoked_keys_store_2 = RevokedKeysStorage()
        revoked_keys_store_3 = RevokedKeysStorage()

        self.assertEqual(revoked_keys_store_1, revoked_keys_store_2)
        self.assertEqual(revoked_keys_store_2, revoked_keys_store_3)
        self.assertEqual(revoked_keys_store_3, revoked_keys_store_1)
